...
Nessa seção será descrito os resultados obtidos através da avaliação do sistema com os usuários.

\section{Avaliação e validação do \textit{framework} }
...
O questionário de avaliação está dividido em 3 conjuntos de perguntas. O primeiro conjunto trata do perfil dos participantes e suas experiências. O segundo conjunto trata do quão útil cada etapa do guia é para alcançar a conformidade legal.
