...
\begin{figure}[ht]
    ...
    \fbox{\includegraphics[width=5.5in]{Images/grafico/01.png}}
    \label{fig: grafico-acc}
...
\begin{figure}[ht]
    ...
    \fbox{\includegraphics[width=5.5in]{Images/grafico/02.png}}
    \label{fig: grafico-acc}
...
\begin{figure}[ht]
    ...
    \fbox{\includegraphics[width=5.5in]{Images/grafico/b03.png}}
    \label{fig: grafico-acc}
