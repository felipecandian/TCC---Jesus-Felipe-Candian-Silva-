...
\begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   Trabalho aprovado. \imprimirlocal, 00 de dezembro de 2022.
...
O questionário de avaliação está dividido em 3 conjuntos de perguntas. O primeiro conjunto trata do perfil dos participantes e suas experiências. O segundo conjunto trata do quão útil cada etapa do guia é para alcançar a conformidade legal. Ao todo foi realizado 12 perguntas de rápida resposta usando radio button e checkbox. O questionário de avaliação está disponível em: \url{https://github.com/felipecandian/TCC-DadosLGPD/tree/main/ANEXOS}
...
\begin{figure}[ht]
    \centering
    \caption{Avaliação.}
    \includegraphics[width=5.0in]{Images/imagemavalaicao.png}
    \label{fig: grafico-acc}
